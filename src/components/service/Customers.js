const customersDark = [
  ...
  { id: 13, image: "assets/img/customers/hager-logo.png" },
  { id: 14, image: "assets/img/customers/honeywell-logo.png" },
  { id: 15, image: "assets/img/customers/hyundai-dymos-logo.png" },
  { id: 16, image: "assets/img/customers/iac-logo.png" },
  { id: 17, image: "assets/img/customers/inema-logo.png" },
  { id: 18, image: "assets/img/customers/insa-logo.png" },
  { id: 19, image: "assets/img/customers/itron-logo.png" },
  { id: 20, image: "assets/img/customers/johnson-controls-logo.png" },
  { id: 21, image: "assets/img/customers/landis-and-gyr-logo.png" },
  { id: 22, image: "assets/img/customers/legrand-logo.png" },
  { id: 23, image: "assets/img/customers/lear-logo.png" },
  { id: 24, image: "assets/img/customers/magna-logo.png" },
  { id: 25, image: "assets/img/customers/novem-logo.png" },
  { id: 26, image: "assets/img/customers/sagemcom-logo.png" },
  { id: 27, image: "assets/img/customers/siemens-logo.png" },
  { id: 28, image: "assets/img/customers/smp-logo.png" },
  { id: 29, image: "assets/img/customers/whirlpool-logo.png" },
  { id: 30, image: "assets/img/customers/yanfeng-logo.png" },
];
